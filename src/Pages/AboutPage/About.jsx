        ...
        <div className="hero-content flex-col lg:flex-row flex-col-reverse mt-32 gap-20">
          <div className="lg:w-1/2 lg:mt-0 lg:text-left w-10/12">
            <div className="lg:w-4/5 space-y-4">
              ...
              <div>
                <p>
                  I love doing web development. Because passionate about work
                  combining technology, creativity and own way of thinking. It
                  is my natural behavior to maintain a good relationship with
                  the client's needs in mind.
                </p>
              </div>
          ...
          <div className="relative lg:ml-14">
            ...
            <div className="mt-3">
              <h2 className="text-3xl font-Rajdhani text-center">
                <span>{typeEffect} Developer</span>
              </h2>
            </div>
          </div>
        </div>
